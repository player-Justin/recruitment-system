...
public class JwtUtils {
    ...
    /**
     * jwt 加密解密密钥
     * 建议通过环境变量 JWT_SECRET 配置，默认值仅用于本地测试
     */
    private static final String JWT_SECRET = System.getProperty("jwt.secret", System.getenv("JWT_SECRET") != null ? System.getenv("JWT_SECRET") : "change-this-in-production");
